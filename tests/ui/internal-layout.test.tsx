...
describe('InternalLayout', () => {
  ...
  it('uses a compact horizontal operations navigation with one active tab', () => {
    ...
    const navigation = screen.getByRole('navigation', { name: 'AI退貨管理系統選單' });
    ...
    expect(screen.queryByRole('heading', { name: 'AI退貨管理系統' })).not.toBeInTheDocument();
    expect(screen.getByText('AI退貨管理系統')).toBeInTheDocument();
