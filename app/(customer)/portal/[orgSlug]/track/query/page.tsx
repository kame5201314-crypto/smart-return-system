...
import { Search, ArrowLeft, Phone, Hash, Package, Clock, CheckCircle, AlertCircle, Truck } from 'lucide-react';
...
import { searchReturnForPortal } from '@/lib/actions/customer-return.actions';
...
export default function OrgTrackQueryPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const result = await searchReturnForPortal({
        orgSlug,
        phone: phone.trim(),
      ...
      if (result.success && result.data) {
        ...
        if (result.data.length === 0) {
          toast.info('查無符合的退貨單，請確認單號與手機號碼');
        } else {
          toast.success('已找到退貨單');
        }
      } else {
    ...
    <div className="min-h-screen bg-gray-50 py-8 px-4">
      <div className="max-w-xl mx-auto">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-500 mt-2">請輸入退貨單號與手機號碼查詢</p>
        </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div className="space-y-2">
                  <Label htmlFor="requestNumber" className="text-teal-700 font-medium flex items-center gap-2">
                        ...
                        <div className="mb-4">
                          ...
                          <div className="grid grid-cols-3 gap-2">
                            {item.return_images.map((img) => (
                              ...
                              >
                                {/* eslint-disable-next-line @next/next/no-img-element -- Customer portal thumbnail; short-lived signed Storage URL with unknown intrinsic dimensions. */}
                                <img
                                  src={img.image_url}
                                  alt="退貨圖片"
                                  loading="lazy"
              ...
              <Card className="bg-white border-0 shadow-lg">
                <CardContent className="pt-6">
                  <div className="text-center text-gray-600">
                    ...
                    <p className="font-medium">查無符合的退貨單</p>
                    <p className="text-sm text-gray-500 mt-1">
                      請確認退貨單號與手機號碼與申請時填寫的一致
                    </p>
                  </div>
                </CardContent>
              </Card>
