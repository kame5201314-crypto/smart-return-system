...
| C4 | Trial / onboarding UI screens | `app/signup/**`, future onboarding page files, `components/saas/**` | Wait for Codex to define final loader/action contracts before wiring writes. |
