...
Scope: Apply and verify migration `044` only on the SaaS Supabase project.

Notes: Owner authorized the registration rollout and opened SQL Editor access for
