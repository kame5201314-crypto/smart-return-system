...
- Public multi-tenant expansion is now explicitly planned by the owner. Shopee P1 isolation is complete; continue tenant-isolation P1/P2 gaps documented in `docs/SAAS_TENANT_ISOLATION_AUDIT.md` before public signup or broad onboarding.
