...
const EXPECTED_LAST_MIGRATION = '055_saas_manual_payment_exact_retry.sql';
...
const REQUIRED_SAAS_MIGRATIONS = [
  ...
  '052_saas_billing_timestamp_integrity.sql',
  '053_saas_manual_payment_history.sql',
  '054_saas_authoritative_payment_history.sql',
  '055_saas_manual_payment_exact_retry.sql',
];
